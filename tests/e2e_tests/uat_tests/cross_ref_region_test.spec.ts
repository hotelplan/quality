...
test.describe('Lapland Region Test', {tag: '@uat'}, () => {
...
test.describe('Santa Region Test', {tag: '@uat'}, () => {
...
test.describe('Ski Region Test', {tag: '@uat'}, () => {
...
test.describe('Walking Region Test', {tag: '@uat'}, () => {
