...
test.describe('Lapland Resort Source Path', {tag: '@uat'}, () => {
...
test.describe('Santa Resort Source Path', {tag: '@uat'}, () => {
...
test.describe('Ski Resort Source Path', {tag: '@uat'}, () => {
...
test.describe('Walking Source Path', {tag: '@uat'}, () => {
