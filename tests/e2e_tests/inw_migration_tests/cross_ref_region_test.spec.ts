...
test.describe('Lapland Region Test', {tag: '@migration'}, () => {
...
test.describe('Santa Region Test', {tag: '@migration'}, () => {
...
test.describe('Ski Region Test', {tag: '@migration'}, () => {
...
test.describe('Walking Region Test', {tag: '@migration'}, () => {
