...
test.describe('Lapland Resort Source Path', {tag: '@migration'}, () => {
...
test.describe('Santa Resort Source Path', {tag: '@migration'}, () => {
...
test.describe('Ski Resort Source Path', {tag: '@migration'}, () => {
...
test.describe('Walking Source Path', {tag: '@migration'}, () => {
